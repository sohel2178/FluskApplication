...
def login():
	...
	if form.validate_on_submit():
		...
		if user and bcrypt.check_password_hash(user.password,form.password.data):
			...
			#Obtain Query Parameter and redirect as per value
...
def account():
	...
	if form.validate_on_submit():
		...
		# Flash Message to tell User Commit is Successful
...
def reset_token(token):
	...
	if form.validate_on_submit():
		...
		flash('Your Password has been updated! Now You are Able to Log in','success')
		return redirect(url_for('login'))
